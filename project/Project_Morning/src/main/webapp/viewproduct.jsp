		...
		<div class="single-product-slider">
			<div class="container">
				...
				int companyid=Integer.parseInt(request.getParameter("companyid"));
				                              				...
				                              				String qry="select * from product where companyid=?";
					...
					<div class="col-lg-3 col-md-6">
						<div class="single-product">
							...
							<div class="product-details">
								<h6><%=rs.getString(3) %> - <%=rs.getString(4) %> - <%=rs.getString(5) %></h6>
								<div class="price">
								...
								<div class="prd-bottom">
									...
									<a href="book.jsp?productid=<%=rs.getInt(1) %>" class="social-info">
										<span class="lnr lnr-move"></span>
										<p class="hover-text">Book Product</p>
									</a>
								</div>
							</div>
						</div>
